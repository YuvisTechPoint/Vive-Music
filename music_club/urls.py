...
urlpatterns = [
    ...
    path('insync/', lambda request: redirect('/user/insync/')),
    path('nowshipping/', lambda request: redirect('/user/nowshipping/')),
    path('about/contact/', lambda request: redirect('/user/contact/')),
    path('used/', lambda request: redirect('/user/used-gear/')),
